...
public class ChannelViewActivity extends ListActivity implements Runnable {
    ...
    class myArrayAdapter extends BaseAdapter { 
        ...
        public String channel2String(byte chan) {
            ...
            if (chan==UAVObjects.getManualControlSettings().getChannelNumberYaw())
                res+=context.getString(R.string.yaw);
            if (chan==UAVObjects.getManualControlSettings().getChannelNumberPitch())
                res+=context.getString(R.string.pitch);
            if (chan==UAVObjects.getManualControlSettings().getChannelNumberRoll())
                res+=context.getString(R.string.roll);
            if (chan==UAVObjects.getManualControlSettings().getChannelNumberThrottle())
                res+=context.getString(R.string.throttle);
            if (chan==UAVObjects.getManualControlSettings().getChannelNumberAccessory0())
                res+=context.getString(R.string.accessory)+"1";
            if (chan==UAVObjects.getManualControlSettings().getChannelNumberAccessory1())
                res+=context.getString(R.string.accessory)+"2";
            if (chan==UAVObjects.getManualControlSettings().getChannelNumberAccessory2())
