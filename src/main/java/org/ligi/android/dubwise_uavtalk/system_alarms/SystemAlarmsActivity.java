 ...
 *
 */
public class SystemAlarmsActivity extends ListActivity implements UAVObjectChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //UAVObjects.getSystemAlarms().getMetaData().
        UAVObjects.getSystemAlarms().addChangeListener(this);
	...
	@Override
	public void notifyUAVObjectChange(UAVObject arg0) {
		refreshOnUIThread();
	}
}
